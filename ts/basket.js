...
const cardBascket = document.querySelector(".cards");
const parentBascket = document.querySelector(".parent_bascket");
...
if (!localStorage.hasOwnProperty("bascket")) {
    ...
    const dataReceived = JSON.parse(localStorage.getItem("bascket") || "[]");
