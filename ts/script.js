...
function allDataCollector() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch("https://retoolapi.dev/cG7rV9/data");
        allData = yield response.json();
    });
}
function dataReceived(page) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(`https://api-generator.retool.com/cG7rV9/data?_page=${page}&_limit=${countItemsPerPage}`);
        return yield response.json();
    });
}
function changePage(page) {
    return __awaiter(this, void 0, void 0, function* () {
        yield allDataCollector();
        ...
        if (page > totalPages)
            page = totalPages;
        currentPage = page;
        const response = yield dataReceived(page);
...
function addBasketLogic(response) {
    ...
    plus.forEach((btn) => btn.addEventListener("click", () => updateQuantity(btn, response, 1)));
    minus.forEach((btn) => btn.addEventListener("click", () => updateQuantity(btn, response, -1)));
